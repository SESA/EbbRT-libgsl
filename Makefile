...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(srcdir)/config.h.in mkinstalldirs $(srcdir)/gsl_version.h.in \
	$(srcdir)/gsl.spec.in depcomp $(noinst_HEADERS) \
	$(pkginclude_HEADERS) test-driver COPYING THANKS TODO \
	config.guess config.sub install-sh mdate-sh missing ltmain.sh
...
CONFIG_CLEAN_FILES = gsl_version.h gsl.spec
...
ACLOCAL = ${SHELL} /home/handong/github/EbbRT-libgsl/missing aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = x86_64-pc-ebbrt-ar
AUTOCONF = ${SHELL} /home/handong/github/EbbRT-libgsl/missing autoconf
AUTOHEADER = ${SHELL} /home/handong/github/EbbRT-libgsl/missing autoheader
AUTOMAKE = ${SHELL} /home/handong/github/EbbRT-libgsl/missing automake-1.13
AWK = mawk
CC = x86_64-pc-ebbrt-gcc
CCDEPMODE = depmode=none
CFLAGS = -g -O2
CPP = x86_64-pc-ebbrt-gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
...
LD = /home/handong/github/EbbRT/baremetal/ext/toolchain/x86_64-pc-ebbrt/bin/ld
LDFLAGS = 
LIBM = -lm
LIBOBJS =  ${LIBOBJDIR}strdup$U.o
LIBS = -lm 
LIBTOOL = $(SHELL) $(top_builddir)/libtool
LIPO = 
LN_S = ln -s
LTLIBOBJS =  ${LIBOBJDIR}strdup$U.lo
MAINT = #
MAKEINFO = ${SHELL} /home/handong/github/EbbRT-libgsl/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /home/handong/github/EbbRT/baremetal/ext/toolchain/bin/x86_64-pc-ebbrt-nm -B
NMEDIT = 
OBJDUMP = x86_64-pc-ebbrt-objdump
OBJEXT = o
OTOOL = 
OTOOL64 = 
PACKAGE = gsl
...
PATH_SEPARATOR = :
RANLIB = x86_64-pc-ebbrt-ranlib
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/bash
STRIP = x86_64-pc-ebbrt-strip
VERSION = 1.16
abs_builddir = /home/handong/github/EbbRT-libgsl
abs_srcdir = /home/handong/github/EbbRT-libgsl
abs_top_builddir = /home/handong/github/EbbRT-libgsl
abs_top_srcdir = /home/handong/github/EbbRT-libgsl
ac_ct_AR = 
ac_ct_CC = 
ac_ct_DUMPBIN = 
am__include = include
...
dvidir = ${docdir}
exec_prefix = ${prefix}
host = x86_64-pc-ebbrt
host_alias = x86_64-pc-ebbrt
host_cpu = x86_64
host_os = ebbrt
host_vendor = pc
htmldir = ${docdir}
...
install_sh = ${SHELL} /home/handong/github/EbbRT-libgsl/install-sh
...
top_builddir = .
top_srcdir = .
SUBDIRS = gsl utils sys test err const complex cheb block vector matrix permutation combination multiset sort ieee-utils cblas blas linalg eigen specfunc dht qrng rng randist fft poly fit multifit statistics sum integration interpolation histogram ode-initval ode-initval2 roots multiroots min multimin monte ntuple diff deriv cdf wavelet bspline doc
SUBLIBS = block/libgslblock.la blas/libgslblas.la \
	...
	rng/libgslrng.la roots/libgslroots.la \
...
gsl_version.h: $(top_builddir)/config.status $(srcdir)/gsl_version.h.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
gsl.spec: $(top_builddir)/config.status $(srcdir)/gsl.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
libgsl.la: $(libgsl_la_OBJECTS) $(libgsl_la_DEPENDENCIES) $(EXTRA_libgsl_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(libgsl_la_LINK) -rpath $(libdir) $(libgsl_la_OBJECTS) $(libgsl_la_LIBADD) $(LIBS)
...
gsl-histogram$(EXEEXT): $(gsl_histogram_OBJECTS) $(gsl_histogram_DEPENDENCIES) $(EXTRA_gsl_histogram_DEPENDENCIES) 
	@rm -f gsl-histogram$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(gsl_histogram_OBJECTS) $(gsl_histogram_LDADD) $(LIBS)

gsl-randist$(EXEEXT): $(gsl_randist_OBJECTS) $(gsl_randist_DEPENDENCIES) $(EXTRA_gsl_randist_DEPENDENCIES) 
	@rm -f gsl-randist$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(gsl_randist_OBJECTS) $(gsl_randist_LDADD) $(LIBS)
...
#include ./$(DEPDIR)/gsl-histogram.Po
#include ./$(DEPDIR)/gsl-randist.Po
...
recheck: all $(check_SCRIPTS)
	...
	$(MAKE) $(AM_MAKEFLAGS) $(TEST_SUITE_LOG) \
	        ...
	        TEST_LOGS="$$log_list"; \
	exit $$?
test_gsl_histogram.sh.log: test_gsl_histogram.sh
	@p='test_gsl_histogram.sh'; \
	b='test_gsl_histogram.sh'; \
...
installdirs-am:
	for dir in "$(DESTDIR)$(libdir)" "$(DESTDIR)$(bindir)" "$(DESTDIR)$(bindir)" "$(DESTDIR)$(m4datadir)" "$(DESTDIR)$(pkgconfigdir)" "$(DESTDIR)$(pkgincludedir)"; do \
